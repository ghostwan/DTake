...
public class DTakeService extends Service {
    ...
    private String COUNT_PREF = "com.ghostwan.dtake.COUNT_PREF";
    private String LAST_TAKE_PREF = "com.ghostwan.dtake.LAST_TAKE_PREF";
    ...
    public void onCreate() {
        ...
        lastTake = sharedPreferences.getLong(LAST_TAKE_PREF, -1);
    ...
    private void updateNotification () {
        ...
        String lastTakenString = getDurationBreakdown(timeDifference);
    ...
    private BroadcastReceiver takeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            editor.putLong(LAST_TAKE_PREF, lastTake);
